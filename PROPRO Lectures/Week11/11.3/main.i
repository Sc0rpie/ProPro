...
int main()
{
    ...
    saveToFile("out1.bin", arr1, 10);
    saveToFile("out1.bin", arr3, 10);

    arr1 = loadFromFile("out1.bin", 10);

    saveToFile("out2.bin", arr2, 10);
    arr3 = loadFromFile("out2.bin", 10);
    arr2 = loadFromFile("out1.bin",10);
