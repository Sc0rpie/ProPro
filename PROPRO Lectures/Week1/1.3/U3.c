...
int main() {
   ...
   printf("Si programa isves pasikartojimo daznio lentele is pateiktos 10-ties skaiciu sekos\n\n");
   ...
   while(counter < SIZE){
      ...
      if((scanf("%d", &num) == 1) && (getchar() == '\n')){
         if ((num >= 0) && (num <= FREQ_SIZE-1)){
            ...
            printf("Ivestas skaicius atitinka parametrus\n\n");
         } else {
   ...
   printf("\n");
   printf("Duomenys yra apdorojami...\n\n");
